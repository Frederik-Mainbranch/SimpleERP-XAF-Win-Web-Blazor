...
using Auftragserfassung_Blazor.Blazor.Server.Services;

namespace Auftragserfassung_Blazor.Blazor.Server {
    public partial class Auftragserfassung_BlazorBlazorApplication : BlazorApplication {
        public Auftragserfassung_BlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void Auftragserfassung_BlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
